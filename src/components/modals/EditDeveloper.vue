...
<div style="min-width: 800px; min-height: 500px;" class="purple p-16">
    <div v-if="!isLoading" class="flex flex-col">
        ...
        <Form @submit="onSubmit" :validation-schema="editDeveloper">
            ...
            <Input class="mt-2" :value="(data as Developer).headquarters" :place-holder="'Enter headquarters...'"  :name="'headquarters'" :label="'Headquarters'"></Input>
            <Input class="mt-2" :value="(data as Developer).description" :is-text-area="true" :type="'textarea'"   :place-holder="'Description...'"  :name="'description'" :label="'Description'"></Input>
            <FileInput class="mt-2" :name="'photo'" :accept="'image/*'" :placeholder="'Add a new photo'" :label="''"> </FileInput>    
