...
function onSubmit(){
    deleteModalData('Developer successifuly deleted.', 'home')
...
<div style="min-width: 800px; max-width: 800px; min-height: 500px;" class="purple p-16">
    <div class="flex flex-col">
        ...
        <a class="text-red-500 text-xl">Are you sure you want to delete this developer!!!</a>
        <a class="text-red-500 text-xl">Developers games will be deleted aswell!!!</a>
